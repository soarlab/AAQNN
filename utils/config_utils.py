...
#ROCCO BUG CORRECTED:     'epochs' :[True, None, int],
#ROCCO BUG CORRECTED:    'finetune':[True, None, str],
...
class Config:
    ...
    def postprocess(self):
        ...
        self.out_wght_path = './weightsQNN/s{}_{}_{}_{}b_{}b_{}_{}_{}_{}_{}_{}.hdf5'.format(self.seed,self.dataset,self.network_type, self.abits, self.wbits, self.nla, self.nfa, self.nlb,
                                                                            self.nfb, self.nlc, self.nfc)
        self.tensorboard_name = 's{}_{}_{}_{}b_{}b_{}_{}_{}_{}_{}_{}.hdf5'.format(self.seed,self.dataset,self.network_type, self.abits, self.wbits, self.nla, self.nfa, self.nlb,
                                                                            self.nfb, self.nlc, self.nfc)
